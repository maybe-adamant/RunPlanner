...
import { createCandidateProjectionCore } from '@planner/projections/candidates/candidateProjectionSession';
import { createTraitCandidateAdapters } from '@planner/projections/candidates/candidateTraitAdapters';
