...
interface HubSlotMembershipProps {
  ...
  readonly slotAddress: ReturnType<typeof createHubSlotAddress>;
...
function HubVisitControl({
  ...
  readonly project: ProjectDocument;
  readonly visit: ReturnType<typeof createHubVisitAddress>;
}) {
  type Projection = {
...
function SideGenerationControl({
  address,
  candidateProjection,
  entered,
  generation,
  ...
  readonly address: ReturnType<typeof createLocalChildAddress>;
  readonly candidateProjection: CandidateProjectionService;
...
function SideEntryAction({
  ...
  readonly disabled?: boolean;
  readonly group: ReturnType<typeof createLocalChildGroupAddress>;
