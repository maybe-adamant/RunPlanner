...
| Fixed biome completion                | A terminal continues through a biome-owned ordered sequence of derived rooms, which may omit postboss rooms        | **Exact:** layout-ordered derived Room Declarations followed by the declared next step              | documented; declarations and simulation pending                 | --                                                           |
