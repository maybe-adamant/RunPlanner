...
| Miniboss rewards            | Every supported miniboss forces `TyphonBossRewards`                                                                 | **Exact:** counted concrete reward from that store on every physical offer        | documented       | --                                                              |
...
Q uses the possibility-only picker contract from `../GAME_GENERATION_RULES.md`.
