...
| Layout-derived completion sequences        | ported   | `../design/GAME_GENERATION_RULES.md`, concrete biome rule documents                                      | F history walks layout-owned Boss/PostBoss declarations and explicit biome-local resets without authored occurrences or room-name dispatch.                                                   |
