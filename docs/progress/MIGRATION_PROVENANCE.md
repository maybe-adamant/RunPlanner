...
| Family                     | Status   | Primary evidence                                                                                           | Port action                                                                                                                                                 |
| -------------------------- | -------- | ---------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| I layout and bounds        | ported   | `RoomDataI.lua`, physical maps, `../biomes/I_GAME_RULES.md`                                                | Sole fixed Intro, authored second-door Story, thirteen bounded continuations, exact 23-target bound, and conditional-terminal Clockwork batches normalize.  |
...
| I authored topology        | ported   | `../design/AUTHORED_PROJECT_MODEL.md`, `../biomes/I_GAME_RULES.md`                                         | Schema v4 owns the bounded biome field, Intro continuation, authored Story target, Clockwork batches, repeated preboss occurrences, and picked-only shop.   |
| I canonical/history        | ported   | `../design/SIMULATION_AND_VALIDATION.md`, `../design/ROOM_LIFECYCLE_MODEL.md`, `../biomes/I_GAME_RULES.md` | Intro, generated Story, pre-generation Goal/NonGoal derivation, entered counter timing, repeated preboss offers, and the fixed completion tail materialize. |
