...
| I authored topology        | ported   | `../design/AUTHORED_PROJECT_MODEL.md`, `../biomes/I_GAME_RULES.md`                                         | Schema v4 owns the bounded biome field, fixed-entry continuation, Clockwork batches, repeated preboss occurrences, and picked-only shop.              |
| I canonical/history        | ported   | `../design/SIMULATION_AND_VALIDATION.md`, `../design/ROOM_LIFECYCLE_MODEL.md`, `../biomes/I_GAME_RULES.md` | Fixed entries, pre-generation Goal/NonGoal derivation, entered counter timing, repeated preboss offers, and the fixed completion tail materialize.    |
