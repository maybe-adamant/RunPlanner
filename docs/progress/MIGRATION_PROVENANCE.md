...
| Route-structural detour suppression        | ready    | `../design/GAME_GENERATION_RULES.md`, `../design/GAME_INTEGRATION_BOUNDARY.md` | Suppress natural Chaos and Anomaly replacement until layouts can represent detour entry and return.                                                                                           |
