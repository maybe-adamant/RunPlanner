...
| Route-structural detours                   | ported   | `../design/CATALOG_MODEL.md`, `../design/AUTHORED_PROJECT_MODEL.md`, `../design/ROOM_LIFECYCLE_MODEL.md`   | Closed Anomaly replacement and Zagreus additional exits use ordinary occurrences and automatic host returns; natural Chaos remains separately suppressed.                                                        |
