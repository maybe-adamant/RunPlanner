...
| `NarcissusH` | Life Savings          | missing Death Defiance plus collapsed Lotus unlock | one `LastStandDrop` and Lotus; preserve the preferred pickup history while the [runtime fallback audit](RUNTIME_OFFER_FALLBACK_AUDIT.md) owns volatile live eligibility without simulating Death Defiance counts |
...
| `EchoDeathDefianceRefill`      | Survive Survive Survive | missing Death Defiance                                                               | retain the preferred trait identity while the [runtime fallback audit](RUNTIME_OFFER_FALLBACK_AUDIT.md) owns volatile live eligibility; restoration count and healing remain outside the planner                                                                                                                                                               |
...
preferred authored result; the [runtime fallback audit](RUNTIME_OFFER_FALLBACK_AUDIT.md)
