...
| `This completion room is derived from the biome layout and is not an authored occurrence.` | Omit. The completion identity and Room Timeline already explain the surface.                        | `BiomeWorkspace.tsx`                             |
