...
| `NarcissusH` | Life Savings          | missing Death Defiance plus collapsed Lotus unlock | one `LastStandDrop` and Lotus; preserve the exact authored pickup history while the [runtime eligibility audit](../rewards-and-acquisition/RUNTIME_OFFER_FALLBACK_AUDIT.md) owns live-mismatch handling without simulating Death Defiance counts |
...
| `EchoDeathDefianceRefill`      | Survive Survive Survive | missing Death Defiance                                                               | retain the exact trait identity while the [runtime eligibility audit](../rewards-and-acquisition/RUNTIME_OFFER_FALLBACK_AUDIT.md) owns volatile live-mismatch handling; restoration count and healing remain outside the planner                                                                                                                               |
...
authored result; the [runtime eligibility audit](../rewards-and-acquisition/RUNTIME_OFFER_FALLBACK_AUDIT.md)
