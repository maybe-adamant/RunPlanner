...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Trait or Pom loot screen | `UseLoot`, `CreateBoonLootButtons`, `CreateUpgradeChoiceButton`, `HandleUpgradeChoiceSelection`, `HandleLootPickup` | Covered for published trait offers and visible level resolutions.                                                                                                         |
...
| Direct random level item | `UseStoreRewardRandomStack` -> `AddStackToTraits`                                                                   | Covered by the direct-level adapter for published `levelResolution`; this is the Nectar/Pom Slice carrier that generic Pom hooks do not cover.                            |
...
| `StackUpgrade`, `StackUpgradeBig`, `StackUpgradeTriple`                                                                                                                      | Visible target choice plus level count                                               | Covered through the loot-screen level carrier.                                                                   |
...
| `StoreRewardRandomStack`                                                                                   | One random eligible trait gains one level   | Covered through `AddStackToTraits`, not the Pom screen.                                                                                               |
...
| `GiftDrop`                                                                                                 | Nectar plus one random eligible trait level | Covered through `UseStoreRewardRandomStack` / `AddStackToTraits`; the Nectar resource itself is simulation-neutral.                                   |
