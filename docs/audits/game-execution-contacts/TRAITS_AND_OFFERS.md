...
| ---------------- | ------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------- |
| Olympian         | Aphrodite, Apollo, Ares, Demeter, Hephaestus, Hera, Hestia, Poseidon, Zeus            | `UseLoot` -> `CreateBoonLootButtons` -> `HandleUpgradeChoiceSelection`                                          | Covered.                                                        |
| Hermes           | Hermes                                                                                | Same generic loot flow                                                                                          | Covered.                                                        |
| Hammer           | Weapon Upgrade                                                                        | Same generic choice flow with Hammer traits                                                                     | Covered.                                                        |
...
| ----------------------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------- |
| Selected option               | `ExecutionTraitOffer.selected`                                         | Choice-button construction and selection                           | Covered.                                                                                                               |
| Vow of Denial rejected option | `rejected`                                                             | Native blocked-index list                                          | Covered; the option remains visible but unselectable.                                                                  |
| Rarity                        | option `rarity`                                                        | Choice data before button construction                             | Covered.                                                                                                               |
| Effective level               | option `effectiveLevel`                                                | Choice data before button construction                             | Covered.                                                                                                               |
| Replacement                   | option `replacement`                                                   | `TraitToReplace` / `OldRarity` on the native option                | Covered.                                                                                                               |
...
| `seaStar`                | `DoubleRewardBoon`                                                                                                                                                                        | Optional duplicate of an eligible pickup                                             | Covered through the published `seaStarDuplicate` producer relation and duplicate creation contact.                                                        |
