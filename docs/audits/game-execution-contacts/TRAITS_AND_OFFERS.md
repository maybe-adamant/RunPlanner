...
| Bespoke NPC menu | Medea, Circe, Icarus, Echo                                                            | Each NPC's named choice function in `Scripts/EventLogic.lua`                           | Deferred route; their exact trait-menu bridges are isolated with NPC acquisitions but are not route-coverage evidence. |
...
| `seaStar`                | `DoubleRewardBoon`                                                                                                                                                                        | Optional duplicate of an eligible pickup                                             | Covered: v17 publishes explicit proc/no-proc for eligible closed carriers and scopes the native duplicate chance without binding the child object.                                                                                       |
