...
| `worldShopRestock`       | `RestockBoon`                                                                                                                                                                             | Add the Travel Deal refill/purchase relation                                         | Covered by commerce: the Well refill and purchase relation have one owner, while the trait acquire function remains native-authoritative rather than becoming a second semantic authority.                                               |
