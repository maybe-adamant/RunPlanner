...
counted-bag explanations, generated-store outcomes, or semantically distinct
shop purchase orders. Each branch still has one total event order. Equivalent
...
commit predecessor
  ...
  -> simulate authored purchases and derive exit history
