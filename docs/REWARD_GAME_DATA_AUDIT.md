...
| ----- | -------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| F     | Run/Meta generated rewards, forced Run rewards, Story, WorldShop, forked free preboss reward | Exact support; base-store probability simplified                                    |
...
| P     | Run/Meta rewards, WorldShop, forked free preboss reward, linked boss provenance              | Exact NPC-free reward support; NPC gift internals deferred                          |
| Q     | Reward-free spine, `TyphonBossRewards` minibosses, direct `Q_WorldShop`                      | Exact supported reward topology; no invented Run/Meta base store                    |
| H     | Declaration-owned RunProgress offers, ordered cages, WorldShop/free terminal                 | No generated base-store value; exact cage support; `FieldsOptionalRewards` deferred |
| O     | Ordered Run/Meta reward wheels, fixed Devotion, WorldShop                                    | Exact wheel support and source-derived outgoing store; probability simplified       |
| I     | Derived Goal/NonGoal, `TartarusRewards`, `I_WorldShop`                                       | Exact structural support; Goal emits no ordinary concrete acquisition               |
| N     | Persistent `HubRewards` board, RunProgress minibosses, side bags, `WorldShop` lookup         | Exact persistent offer support; NPC internals deferred                              |
