...
| ---------------------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Ordinary World Shop, group 2 | Exclude Ashes, Bones and Nectar; add Fire/Air/Earth/Water Boost (`StoreData.lua:260–268`).              | Catalog Shop option membership needs route-conditioned requirements. Reuse inventory generation for both initial slots and Travel Deal.                                  |
