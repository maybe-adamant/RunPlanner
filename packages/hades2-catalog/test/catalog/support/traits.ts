...
/** Native TraitRequirements groups belong exclusively to ordinary generation. */
export const expectedLinkedBoonRequirementOwners = [
  'DoorHealToFullBoon',
  'WeakPotencyBoon',
...
/** These source pairs retain their context predicate alongside their linked group. */
export const expectedDevotionMixedRequirementOwners = [
  'SprintEchoBoon',
  'CharmCrowdBoon',
  'AllCloseBoon',
  'MaxHealthDamageBoon',
